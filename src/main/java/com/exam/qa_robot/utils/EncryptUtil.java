...
//        String encrypt = EncryptUtil.encrypt("114514");
//        System.out.println(encrypt);
        String decrypt = EncryptUtil.decrypt("A44B94A2FCB00AD9D608FCE125FCFF52AC0CD07FC758DEC9");
        System.out.println(decrypt);
//        String str=",123,2,1,1233,";
//        int len=str.length();
//        str=str.substring(0,len-1);
//        int start = str.lastIndexOf(",")+1;
//        str=str.substring(start,len-1);

//            System.out.println(",12,12,".lastIndexOf(".") );
    }
